...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="background-color: #E9E9EB;text-align:center;">
        ...
        <div style="padding: 15px;">
            <h1 style="text-align: center;margin-bottom: 25px;margin-top: 20px">修改${sessionScope.flower.name}</h1>
            <div style="width: 500px;margin: 0px auto"><!--enctype="multipart/form-data" modelAttribute="flower"-->
                <form class="layui-form layui-form-pane" action="${ctx}/admin/flower/flowerManagement/update" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="${sessionScope.flower.id}">
                    <div class="layui-form-item" style="margin-bottom: 30px">
                        <label class="layui-form-label">商品名</label>
                        <div class="layui-input-block">
                            <input type="text" name="name" value="${sessionScope.flower.name}" lay-verify="required" placeholder="Name" autocomplete="off" class="layui-input" style="width: 400px">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 30px">
                        <label class="layui-form-label">种类</label>
                        <div class="layui-input-block">
                            <input type="text" name="type" value="${sessionScope.flower.type}" lay-verify="required" placeholder="Type" autocomplete="off" class="layui-input" style="width: 400px">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 30px">
                        <label class="layui-form-label">库存</label>
                        <div class="layui-input-block">
                            <input type="text" name="stock" value="${sessionScope.flower.stock}" lay-verify="required" placeholder="Stock" autocomplete="off" class="layui-input" style="width: 400px">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 30px">
                        <label class="layui-form-label">价格</label>
                        <div class="layui-input-block">
                            <input type="text" name="price" value="${sessionScope.flower.price}" lay-verify="required" placeholder="Price" autocomplete="off" class="layui-input" style="width: 400px">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 20px">
                        <label class="layui-form-label">花语</label>
                        <div class="layui-input-block">
                            <input type="text" name="floMean" value="${sessionScope.flower.floMean}" lay-verify="required" placeholder="FlowerMean" autocomplete="off" class="layui-input" style="width: 400px">
                        </div>
                    </div>
